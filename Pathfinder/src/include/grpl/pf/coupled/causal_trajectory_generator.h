...
namespace pf {
  namespace coupled {
     ...
     * chassis odometry to the next generation step, making it possible to embed a feedback loop into the
     * generation phase. 
     */
    class causal_trajectory_generator {
     ...
     private:
      ...
      // That's a fixable problem with a settable parameter to optimize for either sequential or random access.
      template <typename iterator_curve_t>
